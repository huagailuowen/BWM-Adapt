...
CONFIG=configs/evaluation/real97_ball_dual6000_cluster_mean_20260917_v1.json
...
PY
exec .venv/bin/python scripts/evaluation/infer_real97_dual_latent_reference.py --config "$CONFIG" --task ball --output outputs/infer_real97_ball_dual6000_cluster_mean_20260917_v1
