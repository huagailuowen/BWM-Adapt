#!/bin/bash
#SBATCH --job-name=mb-rnd-dino-mlp
...
CONFIG_TEMPLATE=${ROOT}/tmp/run_configs/mass_balance_workspace_random_dinov2_k1q7_111578.yaml
RUN_CONFIG=${ROOT}/tmp/run_configs/mass_balance_workspace_random_dinov2_k1q7_${SLURM_JOB_ID}.yaml
...
sed \
    -e "s/seed_20260902_job_111578/seed_20260902_job_${SLURM_JOB_ID}/" \
    -e 's|/dinov2_k1q7_4envpergpu/|/dinov2_concat_mlp_k1q7_4envpergpu/|' \
    -e '/dinov2_temporal_heads:/a\  dinov2_aggregation_mode: "concat_mlp"\n  dinov2_mlp_hidden_dim: 1024' \
